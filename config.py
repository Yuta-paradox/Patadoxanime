...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7070637536:AAE5N95-nBBddTW7IPfF0hZod0IsP1oU2-E")
...
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002051782530"))
...
try:
    ADMINS=[5925363190]
    for x in (os.environ.get("ADMINS", "6827835777").split()):
        ADMINS.append(int(x))
except ValueError:
